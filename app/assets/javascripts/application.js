...
$(document).ready(function(){
  ...
  $('.article-body>p').css({'color': '#333333','font-family': 'Source code pro','font-size': '20px','line-width': '28px'});
  $('.article-body>p>span').css({'color': '#333333','font-family': 'Source code pro','font-size': '20px','line-width': '28px'});
  $('.article-body>p>em').css({'color': '#333333','font-family': 'Source code pro','font-size': '20px','line-width': '28px'});

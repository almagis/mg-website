...
$(document).ready(function(){
  ...
  $('.article-body>p>span').css({'color': '#333333','font-family': 'Raleway','font-size': '20px','line-width': '28px'});
  $('.article-body>p>em').css({'color': '#333333','font-family': 'Raleway','font-size': '20px','line-width': '28px'});
